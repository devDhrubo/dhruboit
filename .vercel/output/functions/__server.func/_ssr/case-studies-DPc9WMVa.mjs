import { v as veridian, n as nexus, o as orbit, a as vault } from "./Footer-CVp3iCQR.mjs";
const caseStudies = [
  {
    slug: "veridian-store",
    id: "CS_01",
    ...
    summary: "A legacy Shopify storefront was losing Black Friday traffic to mobile crashes. We rebuilt the entire purchase path as a headless, edge-rendered experience — and the next peak season ran without a single minute of downtime.",
    hero: veridian,
  ...
  },
  {
    ...
    summary: "Nexus's portfolio rebalancing was a spreadsheet. We engineered a real-time engine, a biometric-secured client portal, and the operations tooling to let a single advisor run a $50M book.",
    hero: nexus,
  ...
  },
  {
    ...
    summary: "A 40-person ops team was drowning in repetitive questions spread across 14 SaaS tools. We shipped an agentic assistant that reads where the team already works, with the guardrails the security team needed.",
    hero: orbit,
  ...
  },
  {
    ...
    summary: "Vault needed a consumer banking app that felt like a fintech-native product on day one — biometric login, instant transfers, and a card experience that didn't feel like a 2014 banking portal.",
    hero: vault,
