...
import { u as useTheme } from "./router-CHxHafPH.mjs";
import { n as Moon, o as Sun } from "../_libs/lucide-react.mjs";
...
const INITIAL_PORTFOLIO_ITEMS = [
  {
    ...
    summary: "Legacy storefront infrastructure was causing checkout friction and high bounce rates during peak sales. We architected a headless Next.js edge-rendered experience with instant cart state and sub-second page loads.",
  ...
  },
  {
    ...
    summary: "Stride's wealth advisory team was bottlenecked by manual spreadsheet calculations. We built a real-time event-driven rebalancing engine and biometric client portal to scale assets under management effortlessly.",
  ...
  },
  {
    ...
    summary: "Enterprise operations teams were losing hundreds of hours searching across 14 fragmented SaaS tools. We engineered a vector-search RAG agent integrated natively into Slack with strict enterprise role-based permissions.",
  ...
  },
  {
    ...
    summary: "FlowState needed a consumer mobile banking experience offering biometric security, instant P2P transfers, and real-time card telemetry built on a unified codebase.",
...
function savePortfolioItem(itemToSave) {
...
function deletePortfolioItem(slugOrId) {
  const current = getStoredPortfolioItems();
...
function usePortfolioItems() {
  const [items, setItems] = reactExports.useState(() => getStoredPortfolioItems());
...
function ThemeToggle({ className = "" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      children: theme === "light" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { className: "size-3.5 text-accent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "[ Dark ]" })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { className: "size-3.5 text-accent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "[ Light ]" })
      ] })
    }
  );
}
export {
  ThemeToggle as T,
  vault as a,
  deletePortfolioItem as d,
  getStoredPortfolioItems as g,
  nexus as n,
  orbit as o,
  resetPortfolioToDefault as r,
  savePortfolioItem as s,
  usePortfolioItems as u,
  veridian as v
};
